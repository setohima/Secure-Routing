...
SRC =	main.c list.c diff.c debug.c timer_queue.c aodv_socket.c aodv_hello.c \
...
OBJSRC =  $(SRC:aodv_rreq.c)
OBJSRO =  $(SRC:aodv_rreq.o)
OBJS =	$(SRC:%.c=%.o)
